...
public interface CsEnum{
     ...
     */
    enum project{
        PROJECT_STATUS_FREE(0, "自由"),
        PROJECT_STATUS_APPLYING(1, "审批中"),
        PROJECT_STATUS_APPLYED(2, "已生效"),
        PROJECT_STATUS_WORK(3, "施工中"),
        PROJECT_STATUS_COMP(4, "已完成");


        private int value;
        private String descr;

        project(int value, String descr)
        {
            this.value = value;
            this.descr = descr;
        }
    ...
    enum activiti{
        ...
        BUSINESS_KEY_APPLYPROJECT("2:FormKey:", " 2:FormKey: :代表项目申请,FormKey 表单ID + 表单Id，2：代表当前实例 是 项目流程"),
        //请假流程表达式判断
